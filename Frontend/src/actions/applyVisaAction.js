...
export const addMainTravelerData = (mainTravelerData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/api/addMainTraveler`,
      mainTravelerData,
      config
    );
...
export const addCoTravelerData = (coTravelerData) => async (dispatch) => {
  try {
    ...
    axios.defaults.withCredentials = true;
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/api/addCoTraveler`,
      coTravelerData,
      config
    );
...
export const getTravelers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACKEND_URL}/api/getAllTraveler`
    );
...
export const searchTravelers = (key) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACKEND_URL}/api/search/${key}`
    );
...
export const filterByVisaType = (key) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACKEND_URL}/api/filter/${key}`
    );
...
export const filterByDate = (startDate,endDate) => async (dispatch) => {
  try {
    ...
    axios.defaults.withCredentials = true;
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/api/filter/date`,
      {startDate,endDate},
      config
    );
...
export const getTravelerDetails = (mainTravelerId) => async (dispatch) => {
  try {
    ...
    axios.defaults.withCredentials = true;
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/api/getTravelerById`,
      mainTravelerId,
      config
    );
...
export const addOtherFields = (id,OtherFields) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_BACKEND_URL}/api/addOtherTravelerFields/${id}`,
      OtherFields,
      config
    );
...
export const changeCoTravelerStatus = (OtherFields) => async (dispatch) => {
  try {
    ...
    axios.defaults.withCredentials = true;
    const { data } = await axios.put(
      `${process.env.REACT_APP_BACKEND_URL}/api/updateCoTravelerStatus`,
      OtherFields,
      config
    );
...
export const deleteTravelerAction = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_BACKEND_URL}/api/deleteTraveler`,
      {data: {id}},
      config
    );
...
export const getTravelerByUser = (userId) => async (dispatch) => {
  try {
    ...
    axios.defaults.withCredentials = true;
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/api/getByUserId`,
      {userId},
      config
    );
