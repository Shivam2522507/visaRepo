...
function Navbar() {
  ...
  <Link to="/" class="navbar-brand ms-lg-5 ms-md-3 fw-bold fs-3 d-flex align-items-center">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        <Link to="/ApplyVisa" class="nav-link active">Apply Visa</Link>
        </li>
        <li class="nav-item">
        <Link to="/TrackApllication" class="nav-link active">Track Apllication</Link>
        </li>
        <li class="nav-item">
        ...
        <div class="modal-content">
            <form method="post">
                <div class="modal-header">
                    ...
                    <PersonRolodex className="me-2" size={33} />Contact Us
                    </h3>
                ...
                <div class="modal-body">
                  <div className="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <input type="number" name="phone" class="form-control shadow-none" placeholder="Please Enter Contact No." required/>
                    </div>
                    <div class="col-lg-12 mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-control shadow-none" placeholder="Please Enter Email Address" required/>
                    </div>
                    <div class="col-lg-12 mb-4">
                        <label class="form-label">Message</label>
                        <textarea class="form-control shadow-none" name="message" rows="3" placeholder="Write your message"></textarea>
                    </div>
