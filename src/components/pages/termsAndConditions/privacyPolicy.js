...
function PrivacyPolicy() {
    ...
    useEffect(() => {
        const section = document.getElementById("head");
        if (section) {
  ...
  return (
    <>
    <div id="head" className="pt-4 bg-light"></div>
    <div className="container-fluid m-0 p-0 bg-light">
        <div id="section"></div>
      <div className="container pt-4">
        <div className="card p-4 shadow-sm">
          <h1 className="text-center fw-bold mt-2 mb-5" >Privacy Policy</h1>
          <p >Introduction:</p>
          <p>
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>{" "}
            ( Merkabah Group ) recognizes the importance of privacy of its users
            and also of maintaining confidentiality of the information provided
            by its users as a responsible data controller and data processer.
          </p>

          <p>
            This Privacy Policy provides for the practices for handling and
            securing user's Personal Information (defined hereunder) by MERKABAH
            GROUP (
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
          ...
          <p>
            ...
            service(s) made available by MERKABAH GROUP ({" "}
            <a href=" HTTPS://WWW.BUYDUBAIVISAONLINE.COM/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>
            ) through any of MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>{" "}
            ) ’s customer interface channels including its website, mobile site,
            mobile app & offline channels including call centers and offices
          ...
          <p>
            ...
            "our" shall mean MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>{" "}
            ) . For the purpose of this Privacy Policy, Website means the
          ...
          <p>
            ...
            and privacy practices of MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>
            ) ’s business partners, advertisers, sponsors or other sites to
            which MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>
            ...
            privacy statements and policies of any such third parties with whom
            they interact.
          </p>
          ...
          <p>USERS OUTSIDE THE GEOGRAPHICAL LIMITS OF INDIA</p>

          <p>
            Please note that the data shared with MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>{" "}
            ) shall be primarily processed in India and such other jurisdictions
            where a third party engaged by MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>
            ) may process the data on MERKABAH GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>
            ) ’s behalf. By agreeing to this policy, you are providing MERKABAH
            GROUP ({" "}
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
          ...
          <p>
            ...
            email id: life@merkabahgroup.com (
            <a href="https://www.buydubaivisaonline.com/">
              {" "}
              https://www.buydubaivisaonline.com/
            </a>{" "}
            ) .com. However, if such processing of data is essential for us to
            be able to provide service to you, then we may not be able to serve
            or confirm your bookings after your withdrawal of consent. For
            instance, if you want to book any international holiday package in
            fixed departures (group bookings), then certain personal information
            of yours like contact details, gender, dietary preferences, choice
            of room with smoking facility, any medical condition which may
            require specific attention or facility etc. may have to be shared by
            us with our vendors in each city where you will stay, and they may
            further process this information for making suitable arrangements
            for you during the holiday. Such sharing and processing of
            information may extend to the hotel where you will stay or the tour
          ...
          <p>
            ...
            we may have to refuse the booking altogether, or unreasonably
            restrict us to service your booking (if a booking is already made)
            which may further affect your trip or may compel us to cancel your
            booking.
          </p>

          <p>TYPE OF INFORMATION WE COLLECT AND ITS LEGAL BASIS</p>
          <p>
          ...
          <p>
            "Personal Information" of User shall include the information shared
            by the User and collected by us for the following purposes:
          </p>
          <p>
            Registration on the Website: Information which you provide while
            subscribing to or registering on the Website, including but not
            limited to information about your personal identity such as name,
            gender, marital status, religion, age, profile picture etc., your
            contact details such as your email address, postal addresses,
            frequent flyer number, telephone (mobile or otherwise) and/or fax
          ...
          <p>
            ...
            booking through your registered MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) account. In such case, you must confirm and represent that each of
            the other traveler(s) for whom a booking has been made, has agreed
            to have the information shared by you disclosed to us and further be
            shared by us with the concerned service provider(s).
          </p>
          <p>
            If you request MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) to provide visa related services, then copies of your passport,
            bank statements, originals of the filled in application forms,
            photographs, and any other information which may be required by the
          ...
          <p>
            ...
            this information, MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) may not be able to process the booking. MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) will never share User’s PAN details without their prior consent
            unless otherwise such action is required by any law enforcement
            authority for investigation, by court order or in reference to any
            legal process.
          </p>
          <p>
          ...
          <p>
            ...
            purpose. MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) will never process the beneficiary id and other id details
            contained in the vaccination certificate
          </p>
          <p>
            Such information shall be strictly used for the aforesaid specified
            & lawful purpose only. User further understands that MERKABAH GROUP
            ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            ...
            booking. MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) will always redact all/any sensitive & confidential information
            contained in the vaccination certificate, passbook, bank statement
            or any other identity card submitted for the purpose of availing a
            service, promotional offer or booking a product on the Website. In
            case a User does not wish to provide this information or opts for
            deletion of the information already provided, MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) may not be able to process the desired booking request. MERKABAH
            GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            ...
            PAN card details, Vaccination status & certificate , Passport
            details , Aadhar Card details without their prior consent unless
            otherwise such action is required by any law enforcement authority
            for investigation, by court order or in reference to any legal
            process.
          </p>
          ...
          <p>confirm your reservations with respective service providers;</p>
          <p>keep you informed of the transaction status;</p>
          <p>
            send booking confirmations either via sms or Whatsapp or any other
            messaging service;
          </p>
          <p>send any updates or changes to your booking(s);</p>
          <p>allow our customer service to contact you, if necessary;</p>
          <p>
          ...
          <p>send verification message(s) or email(s);</p>
          <p>
          ...
          <p>
            ...
            preferences, develop programs and improve user experience. MERKABAH
            GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            ...
            to win great travel and travel related prizes. Personal Information
            ...
            occasionally receive updates from us about fare sales in your area,
            special offers, new MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) services, other noteworthy items (like savings and benefits on
            airfares, hotel reservations, holiday packages, car rentals and
          ...
          <p>
            ...
            ) may from time to time launch reward programs by way of which users
            may stand to win travel related rewards or other rewards. We may use
            your Personal Information to enroll you in the rewards program and
            status of the same will be visible each time you log in to the
            Website. Depending on the reward program, each time you win a
            reward, MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) may share your Personal Information with a third party that will
            be responsible for fulfilling the reward to you. You may however
            choose to opt out of such reward programs by writing to us. For
            various purposes such as fraud detection, offering bookings on
            credit etc., we at times may verify information of customers on
            selective basis, including their credit information. Additionally,
            MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) may share your Personal Information, anonymized and/ or aggregated
            data to a third party that MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ...
            assessing credit worthiness for offering bookings on credit.
          </p>
          ...
          <p>
            ...
            as is reasonably necessary for the purposes listed in this policy.
            In some circumstances we may retain your Personal Information for
            longer periods of time, for instance where we are required to do so
            in accordance with any legal, regulatory, tax or accounting
            requirements.
          </p>
          <p>
          ...
          <h3 className="fw-bold">COOKIES AND SESSION DATA</h3>
          ...
          <p>
            ...
            ) uses cookies to personalize your experience on the Website and the
            advertisements that maybe displayed. MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) ’s use of cookies is similar to that of any other reputable online
            companies.
          </p>
          <p>
          ...
          <p>
            ...
            by your browser. MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) supports your right to block any unwanted Internet activity,
            especially that of unscrupulous websites. However, blocking MERKABAH
            GROUP (
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            ...
            cookies from websites you trust.
          </p>
          <p className="fw-bold">Automatic Logging of Session Data:</p>
          <p>
          ...
          <p>
            ...
            may note that while making a booking with MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) you authorize us to share your information with the said service
            providers and suppliers. It is pertinent to note that MERKABAH GROUP
            ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            ...
            their part of service. However, how the said service
            providers/suppliers use the information shared with them is beyond
            the purview and control of MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
          ...
          <p>
            ...
            Information of Users to third parties except sharing of such
          ...
          <p>
            If the assets of MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) are acquired, our customer information may also be transferred to
            the acquirer depending upon the nature of such acquisition. In
            addition, as part of business expansion/development/restructuring or
            for any other reason whatsoever, if we decide to
          ...
          <p>BUSINESS PARTNERS and THIRD-PARTY VENDORS:</p>
          <p>
            ...
            If you choose to avail any such services offered by our business
          ...
          <p>
            ...
            ) may share your Personal Information to third party that MERKABAH
            GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
          ...
          <p>
            Occasionally, MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) will hire a third party for market research, surveys etc. and will
            provide information to these third parties specifically for use in
            ...
            agreements and such information is to be used solely for completing
            the specific project, and in compliance with the applicable
            regulations.
          </p>
          <p>DISCLOSURE OF INFORMATION</p>
          <p>
            In addition to the circumstances described above, MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) may disclose User's Personal Information if required to do so:
          </p>
          <p>
          ...
          <p>for regulatory, internal compliance and audit exercise(s)</p>
          <p>to secure our systems; or</p>
          <p>
            to enforce or protect our rights or properties of MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ...
            Personal Information of User(s) is necessary to identify, contact or
          ...
          <p>
            ...
            ) provides an option to its users to post their experiences by way
            of reviews, ratings and general poll questions. The customers also
            have an option of posting questions w.r.t a service offered by
            MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) or post answers to questions raised by other users. MERKABAH GROUP
            ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) may also hire a third party to contact you and gather feedback
            about your recent booking with MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>
            ) . Though the participation in the feedback process is purely
          ...
          <p>Crowd Source Data Collection (poll questions).</p>
          <p>
            Each User who posts review or ratings, Q&A, photographs shall have a
            profile, which other Users will be able to access. Other Users may
            be able to view the number of trips, reviews written, questions
            asked and answered and photographs posted.
          </p>
          <p>HOW CAN YOU OPT-OUT OF RECEIVING OUR PROMOTIONAL E-MAILS?</p>
          <p>
            You will occasionally receive e-mail updates from us about fare
            sales in your area, special offers, new MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) services, and other noteworthy items. We hope you will find these
            updates interesting and informative. If you wish not to receive
            them, please click on the "unsubscribe" link or follow the
            instructions in each e-mail message.
          </p>
          <p>PERMISSIONS REQUIRED FOR USING OUR MOBILE APPLICATIONS</p>
          <p>
            When the MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
            ) app is installed on your phone or tablet, a list of permissions
            appear and are needed for the app to function effectively. There is
            no option to customize the list. The permissions that MERKABAH GROUP
            (
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
          ...
          <p>
            Device & App history: We need your device permission to get
            information about your device, like OS (operating system) name, OS
            version, mobile network, hardware model, unique device identifier,
            preferred language, etc. Basis these inputs, we intend to optimize
            your travel booking experience, use OS specific capabilities to
            drive great in-funnel experiences using components of device’s OS,
            etc.
          </p>
          <p>
            Camera: This permission enables you to use your camera from within
            ...
            enable you to scan QR codes for easy UPI payments.
          </p>
          <p>
            Identity: This permission enables us to know about details of your
            account(s) on your mobile device. We use this info to auto-fill your
            email ID’s and provide a typing free in-funnel experience. It helps
            us map email ID’s to a particular user to give you the benefit of
            exclusive travel offers, wallet cash-backs, etc. It also allows
            facilitating your Facebook and Google+ login.
          </p>
          <p>
            Location: This permission enables us to give you the benefit of
          ...
          <p>
            SMS: If you allow us to access your SMS, we read your SMS to
            ...
            experience while making a booking and you don’t need to move out of
            the app to read the SMS and then enter it in the app.
          </p>
          <p>
            Phone: The app requires access to make phone calls so that you can
            make phone calls to hotels, airlines and our customer contact
            centers directly through the app.
          </p>
          <p>
            Contacts: If you allow us to access your contacts, it enables us to
            ...
            and synced from your phone.
          </p>
          <p>
            Photo/ Media/ Files: The libraries in the app use these permissions
            to allow map data to be saved to your phone's external storage, like
            SD cards. By saving map data locally, your phone doesn't need to
            re-download the same map data every time you use the app. This
            provides you a seamless Map based Hotel selection experience, even
            on low bandwidth network.
          </p>
          <p>
            Wi-Fi connection information: When you allow us the permission to
            detect your Wi-Fi connection, we optimize your experience such as
            more detailing on maps, better image loading, more hotel/ flights/
            package options to choose from, etc.
          </p>
          <p>
            Device ID & Call information: This permission is used to detect your
            Android ID through which we can uniquely identify users. It also
            lets us know your contact details using which we pre-populate
            specific fields to ensure a seamless booking experience.
          </p>
          <p>
            Calendar: This permission enables us to put your travel plan on your
            calendar.
          </p>
          <p>
            Bluetooth: This permission enables us to provide you services of the
          ...
          <p>
            Video/Audio: This permission enables you to upload videos on our
          ...
          <p>
            Phone Number: We need the permission of access to phone number to
            provide a seamless login experience, to optimise your travel booking
            experience and to enable you to obtain UPI services and to prevent
            fraud in some cases on our application
          </p>
          <p>
            IMEI/IMSI: This permission enables us to identifying different users
            uniquely and helps us to prevent frauds on our application.
          </p>
          <p>
            Subscription Information: Your subscription information enables to
            provide you a seamless experience depending upon your network and to
            optimise the application’s performance. In addition this also
            enables us in providing to you the train status even in an offline
            mode and additionally even in a no network area you can get fully
            aware of the status of the train you want to search for.
          </p>
          <p>
            SIM Serial Number: This permission enables us to read your sim
            serial number and helps us in authenticating your mobile number for
            UPI registration. It helps us to ensure that the mobile number you
            are using is actually present on your device that you are using to
            register for UPI.
          </p>
          <p>IOS Permissions:</p>
          <p>
            Notifications: If you opt in for notifications, it enables us to
            send across exclusive deals, promotional offers, travel related
            updates, etc. on your device. If you do not opt for this, updates
            for your travel like PNR status, booking confirmation, refund (in
            case of cancellation), etc. will be sent through SMS.
          </p>
          <p>
            Contacts: If you opt in for contacts permission, it enables us to
            provide a lot of social features to you such as sharing your hotel/
            flight/ holidays with your friends, inviting your friends to try our
            app, send across referral links to your friends, etc. We will also
            use this information to make recommendations for hotels where your
            friends have stayed. This information will be stored on our servers
            and synced from your phone.
          </p>
          <p>
            Location: This permission enables us to give you the benefit of
            location specific deals and provide you a personalized in-funnel
            experience. When you launch our app to make a travel booking, we
            ...
            hotels in case you are running late and want to make a quick last
            minute booking for the nearest hotel. Your options are personalized
          ...
          <p>WITHDRAWAL OF CONSENT AND PERMISSION</p>
          <p>
            ...
            sending an email to privacy@go-Merkabah Group ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
          ...
          <p>YOUR RIGHTS QUA PERSONAL INFORMATION</p>
          <p>
          ...
          <p>
            ELIGIBILITY TO TRANSACT WITH MERKABAH GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
          ...
          <p>
            You must atleast 18 years of age to transact directly with MERKABAH
            GROUP ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
          ...
          <p>
            ...
            email to us at life@merkabahgroup.com ({" "}
            <a href="HTTPS://WWW.BUYDUBAIVISAONLINE.COM/ ">
              {" "}
              HTTPS://WWW.BUYDUBAIVISAONLINE.COM/{" "}
            </a>{" "}
